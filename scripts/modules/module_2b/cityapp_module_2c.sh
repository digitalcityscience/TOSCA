...
#############
    ...
    #  If you want to draw a new query area, click 'Draw' button, draw the area you want to query, then click 'Save'. If you want to exit, click 'Cancel'.
        Send_Message m 1 module_2c.1 question actions [\"Map\",\"Draw\",\"Cancel\"]
            Request
            case $REQUEST_CONTENT in
                ...
                "cancel"|"Cancel"|"CANCEL")
                    ...
                    Send_Message m 2 module_2c.2 question actions [\"OK\"]
                        Request
                        Running_Check stop
                        Close_Process
                    exit;;
...
##############
    ...
    Process_Check start calculations
        ...
        grass $GRASS/$MAPSET --exec ~/cityapp/scripts/modules/module_2b/module_2c_query_process.sh
