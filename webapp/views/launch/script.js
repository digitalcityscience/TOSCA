...
<div class='row justify-content-between mb-2'>
  <small class='col-md-2'>min <span class='min-badge badge badge-secondary'> >= ${bounds[0]}</span></small>
  <input type='number' class='col-md-10 form-control min'>
  <small class='col-md-2'>max <span class='max-badge badge badge-secondary'> <= ${bounds[1]}</span></small>
